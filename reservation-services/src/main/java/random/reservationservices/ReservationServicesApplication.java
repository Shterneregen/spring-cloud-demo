...
public class ReservationServicesApplication {
    ...
    private static final String GROUP_NAME = "Reservations";
    private static final String BASE_PACKAGE = "random.reservationservices";
    private static final String API_INFO_TITLE = "Reservation Services";
    private static final String API_INFO_DESCRIPTION = "A set of services to provide data access to reservations";
